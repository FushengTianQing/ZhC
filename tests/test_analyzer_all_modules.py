...
class TestMemorySafety(unittest.TestCase):
    ...
    def test_bounds_checker(self):
        from zhc.analyzer.memory_safety import BoundsChecker
    ...
    def test_lifetime_analyzer(self):
        ...
        analyzer.track_lifetime("x", 1, 10)
        issue = analyzer.check_lifetime("y", "x", 5)
        self.assertIsNone(issue)
...
class TestPerformance(unittest.TestCase):
    ...
    def test_optimized_scope_manager(self):
        ...
        # OptimizedScopeManager 继承 ScopeManager
        manager = OptimizedScopeManager()
        manager.enter_scope("test", None)
        self.assertIsNotNone(manager.current_scope)
    ...
    def test_symbol_lookup_optimizer_class(self):
        ...
        self.assertIsNotNone(o.lookup_symbol("x"))
...
class TestPointerAnalysis(unittest.TestCase):
    ...
    def test_reference_count(self):
        ...
        a = PointerAnalyzer()
        a.pointers["ref"] = type(
            "Ref", (), {"reference_count": 1, "is_shared_ptr": True}
        )()
