...
import pytest
from src.ir.loop_unroller import (
    LoopUnroller,
    UnrollStrategy,
    UnrollDecision,
    UnrollResult,
...
from src.ir.instructions import IRBasicBlock, IRInstruction
from src.ir.program import IRFunction
from src.ir.values import IRValue, ValueKind
from src.ir.opcodes import Opcode
from src.ir.loop_optimizer import LoopInfo
...
class TestLoopUnroller:
    ...
    def test_estimate_loop_body_size(self):
        ...
        header.instructions.append(
            IRInstruction(Opcode.ADD, [], "i")
        )
        body.instructions.append(
            IRInstruction(Opcode.MUL, [], "x")
        )
        body.instructions.append(
            IRInstruction(Opcode.SUB, [], "y")
        )
    ...
    def test_clone_basic_block(self):
        ...
        original.instructions.append(
            IRInstruction(Opcode.ADD, ["a", "b"], ["c"])
        )
        original.instructions.append(
            IRInstruction(Opcode.MUL, ["c", "d"], ["e"])
        )
