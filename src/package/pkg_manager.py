...
class AliasManager:
    ...
    def _save_custom_aliases(self):
        ...
        try:
            ...
            with open(self.config_path, 'w', encoding='utf-8') as f:
                json.dump({'aliases': self.custom_aliases}, f, ensure_ascii=False, indent=2)
    ...
    def register_alias(self, alias: str, command: str) -> Tuple[bool, str]:
        ...
        # 检查命令是否有效
        valid_commands = set(CommandMapper.EN_TO_CN.keys()) | set(CommandMapper.CN_TO_EN.values())
...
class PackageManager:
    ...
    def execute_voice_command(self, voice_text: str) -> Tuple[bool, str, Dict]:
        ...
        return result[0], result[1], parsed if isinstance(result, tuple) else (True, str(result), parsed)
