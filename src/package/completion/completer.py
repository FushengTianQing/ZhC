...
class ZHCCompleter:
    ...
    def complete(self, command: str, current_word: str, prev_word: str = None) -> List[str]:
        """
        智能补全
    ...
    def get_command_help(self, command: str) -> str:
        ...
        # 转换为中文命令
        cn_command = CommandMapper.to_chinese(command) if command in CommandMapper.EN_TO_CN else command
