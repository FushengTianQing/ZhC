...
class ZHCLLLDBCommands:
    ...
    def zhc_list(self, debugger: lldb.SBDebugger):
        ...
        self.interpreter.HandleCommand(
            f'source list -f {file_spec.filename} -l {line_number - 5} -c 10',
            result
        )
...
def zhc_help(debugger: lldb.SBDebugger, command: str, result: lldb.SBCommandReturnObject, internal_dict: dict):
    """zhc-help命令实现"""
...
def zhc_break(debugger: lldb.SBDebugger, command: str, result: lldb.SBCommandReturnObject, internal_dict: dict):
    """zhc-break命令实现"""
...
def zhc_list(debugger: lldb.SBDebugger, command: str, result: lldb.SBCommandReturnObject, internal_dict: dict):
    """zhc-list命令实现"""
    cmds = ZHCLLLDBCommands(debugger)
    cmds.zhc_list(debugger)


def zhc_print(debugger: lldb.SBDebugger, command: str, result: lldb.SBCommandReturnObject, internal_dict: dict):
    """zhc-print命令实现"""
    if not command.strip():
...
def zhc_where(debugger: lldb.SBDebugger, command: str, result: lldb.SBCommandReturnObject, internal_dict: dict):
    """zhc-where命令实现"""
    cmds = ZHCLLLDBCommands(debugger)
    cmds.zhc_where(debugger)


def zhc_info(debugger: lldb.SBDebugger, command: str, result: lldb.SBCommandReturnObject, internal_dict: dict):
    """zhc-info命令实现"""
    cmds = ZHCLLLDBCommands(debugger)
    cmds.zhc_info(debugger)


def zhc_types(debugger: lldb.SBDebugger, command: str, result: lldb.SBCommandReturnObject, internal_dict: dict):
    """zhc-types命令实现"""
    cmds = ZHCLLLDBCommands(debugger)
    cmds.zhc_types()


def zhc_symbols(debugger: lldb.SBDebugger, command: str, result: lldb.SBCommandReturnObject, internal_dict: dict):
    """zhc-symbols命令实现"""
    cmds = ZHCLLLDBCommands(debugger)
