...
class AsyncParser:
    ...
    def _parse_parameter_list(self) -> List[Parameter]:
        ...
        while True:
            ...
            parameters.append(Parameter(name=name_token.value, param_type=param_type))
    ...
    def _parse_await_statement(self) -> AwaitNode:
        ...
        return AwaitNode(expression=expression, line=line, column=column)
    ...
    def _parse_return_statement(self) -> ReturnNode:
        ...
        return ReturnNode(value=value, is_async=True, line=line, column=column)
