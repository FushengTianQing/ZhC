...
class ModuleDeclNode(ASTNode):
    ...
    def __init__(self, name: str, exports: List[str], imports: List[str], body: List[ASTNode],
...
class ImportDeclNode(ASTNode):
    ...
    def __init__(self, module_name: str, symbols: Optional[List[str]], line: int = 0, column: int = 0):
...
class FunctionDeclNode(ASTNode):
    ...
    def __init__(self, name: str, return_type: ASTNode, params: List[ASTNode],
                 body: Optional[ASTNode], line: int = 0, column: int = 0):
...
class StructDeclNode(ASTNode):
    ...
    def __init__(self, name: str, members: List[ASTNode], line: int = 0, column: int = 0):
...
class EnumDeclNode(ASTNode):
    ...
    def __init__(self, name: Optional[str], values: List[Tuple[str, Optional[ASTNode]]],
                 line: int = 0, column: int = 0):
...
class TypedefDeclNode(ASTNode):
    ...
    def __init__(self, old_type: ASTNode, new_name: str, line: int = 0, column: int = 0):
...
class VariableDeclNode(ASTNode):
    ...
    def __init__(self, name: str, var_type: ASTNode, init: Optional[ASTNode],
                 is_const: bool = False, line: int = 0, column: int = 0):
...
class ParamDeclNode(ASTNode):
    ...
    def __init__(self, name: str, param_type: ASTNode, default_value: Optional[ASTNode] = None,
                 line: int = 0, column: int = 0):
...
class ForStmtNode(ASTNode):
    ...
    def __init__(self, init: Optional[ASTNode], condition: Optional[ASTNode],
                 update: Optional[ASTNode], body: ASTNode, line: int = 0, column: int = 0):
...
class DoWhileStmtNode(ASTNode):
    ...
    def __init__(self, body: ASTNode, condition: ASTNode, line: int = 0, column: int = 0):
...
class SwitchStmtNode(ASTNode):
    ...
    def __init__(self, expr: ASTNode, cases: List[ASTNode], line: int = 0, column: int = 0):
...
class CaseStmtNode(ASTNode):
    ...
    def __init__(self, value: Optional[ASTNode], statements: List[ASTNode],
                 line: int = 0, column: int = 0):
...
class LabelStmtNode(ASTNode):
    ...
    def __init__(self, name: str, statement: Optional[ASTNode], line: int = 0, column: int = 0):
...
class UnaryExprNode(ASTNode):
    ...
    def __init__(self, operator: str, operand: ASTNode, is_prefix: bool = True,
                 line: int = 0, column: int = 0):
...
class CallExprNode(ASTNode):
    ...
    def __init__(self, callee: ASTNode, args: List[ASTNode], line: int = 0, column: int = 0):
...
class CastExprNode(ASTNode):
    ...
    def __init__(self, cast_type: ASTNode, expr: ASTNode, line: int = 0, column: int = 0):
...
class StructInitNode(ASTNode):
    ...
    def __init__(self, values: List[ASTNode], field_names: Optional[List[str]] = None,
                 line: int = 0, column: int = 0):
...
class ArrayTypeNode(ASTNode):
    ...
    def __init__(self, element_type: ASTNode, size: Optional[ASTNode],
                 line: int = 0, column: int = 0):
...
class FunctionTypeNode(ASTNode):
    ...
    def __init__(self, return_type: ASTNode, param_types: List[ASTNode],
                 line: int = 0, column: int = 0):
