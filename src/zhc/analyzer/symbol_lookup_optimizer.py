...
class SymbolLookupOptimizer:
    ...
    def update_symbol(self, symbol_name: str, symbol_info: Any) -> None:
        """
        更新符号（增量更新）
    ...
    def remove_symbol(self, symbol_name: str) -> bool:
        ...
        # 清除查找路径缓存
        keys_to_remove = [key for key in self._lookup_path_cache if symbol_name in key]
