...
class LLVMTypeMapper:
    ...
    BASIC_TYPES: Dict[str, TypeInfo] = {
        ...
        "长整数型": TypeInfo("长整数型", "i64", 64, True, False, False, "64位有符号整数"),
        "短整数型": TypeInfo("短整数型", "i16", 16, True, False, False, "16位有符号整数"),
        "字节型": TypeInfo("字节型", "i8", 8, True, False, False, "8位有符号整数"),
        "无符号整数型": TypeInfo("无符号整数型", "i32", 32, False, False, False, "32位无符号整数"),
        "无符号长整数型": TypeInfo("无符号长整数型", "i64", 64, False, False, False, "64位无符号整数"),
        
        # 浮点类型
        "浮点型": TypeInfo("浮点型", "float", 32, False, True, False, "32位单精度浮点"),
        "双精度浮点型": TypeInfo("双精度浮点型", "double", 64, False, True, False, "64位双精度浮点"),
    ...
    def map_function_type(self, return_type: str, param_types: List[str]) -> ll.FunctionType:
        """映射函数类型
    ...
    def create_struct_type(self, name: str, fields: List[Tuple[str, str]]) -> ll.LiteralStructType:
        """创建结构体类型
