...
class LLVMInstructionGenerator:
    ...
    INSTRUCTION_MAP: Dict[Opcode, InstructionInfo] = {
        ...
        Opcode.GETPTR: InstructionInfo(Opcode.GETPTR, "getelementptr", "内存", True, "获取指针"),
        Opcode.GEP: InstructionInfo(Opcode.GEP, "getelementptr", "内存", True, "指针运算"),
        ...
        Opcode.SWITCH: InstructionInfo(Opcode.SWITCH, "switch", "控制流", False, "分支跳转"),
        ...
        Opcode.BITCAST: InstructionInfo(Opcode.BITCAST, "bitcast", "转换", True, "位转换"),
        Opcode.INT2PTR: InstructionInfo(Opcode.INT2PTR, "inttoptr", "转换", True, "整数到指针"),
        Opcode.PTR2INT: InstructionInfo(Opcode.PTR2INT, "ptrtoint", "转换", True, "指针到整数"),
    }
    ...
    def generate(self, builder: ll.IRBuilder, instr: IRInstruction, 
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> Optional[ll.Value]:
        """生成 LLVM 指令
    ...
    def _gen_add(self, builder: ll.IRBuilder, instr: IRInstruction,
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> ll.Value:
        """生成加法指令"""
    ...
    def _gen_sub(self, builder: ll.IRBuilder, instr: IRInstruction,
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> ll.Value:
        """生成减法指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_mul(self, builder: ll.IRBuilder, instr: IRInstruction,
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> ll.Value:
        """生成乘法指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_div(self, builder: ll.IRBuilder, instr: IRInstruction,
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> ll.Value:
        """生成除法指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_mod(self, builder: ll.IRBuilder, instr: IRInstruction,
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> ll.Value:
        """生成取模指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_icmp_eq(self, builder: ll.IRBuilder, instr: IRInstruction,
                     values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                     functions: Dict[str, ll.Function]) -> ll.Value:
        """生成等于比较指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_icmp_ne(self, builder: ll.IRBuilder, instr: IRInstruction,
                     values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                     functions: Dict[str, ll.Function]) -> ll.Value:
        """生成不等于比较指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_icmp_lt(self, builder: ll.IRBuilder, instr: IRInstruction,
                     values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                     functions: Dict[str, ll.Function]) -> ll.Value:
        """生成小于比较指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_icmp_le(self, builder: ll.IRBuilder, instr: IRInstruction,
                     values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                     functions: Dict[str, ll.Function]) -> ll.Value:
        """生成小于等于比较指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_icmp_gt(self, builder: ll.IRBuilder, instr: IRInstruction,
                     values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                     functions: Dict[str, ll.Function]) -> ll.Value:
        """生成大于比较指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_icmp_ge(self, builder: ll.IRBuilder, instr: IRInstruction,
                     values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                     functions: Dict[str, ll.Function]) -> ll.Value:
        """生成大于等于比较指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_and(self, builder: ll.IRBuilder, instr: IRInstruction,
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> ll.Value:
        """生成按位与指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_or(self, builder: ll.IRBuilder, instr: IRInstruction,
               values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
               functions: Dict[str, ll.Function]) -> ll.Value:
        """生成按位或指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_xor(self, builder: ll.IRBuilder, instr: IRInstruction,
                values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                functions: Dict[str, ll.Function]) -> ll.Value:
        """生成按位异或指令"""
        a = self._get_value(instr.operands[0], values)
    ...
    def _gen_alloca(self, builder: ll.IRBuilder, instr: IRInstruction,
                    values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                    functions: Dict[str, ll.Function]) -> ll.Value:
        """生成内存分配指令"""
        # 获取类型
    ...
    def _gen_load(self, builder: ll.IRBuilder, instr: IRInstruction,
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> ll.Value:
        """生成加载指令"""
    ...
    def _gen_store(self, builder: ll.IRBuilder, instr: IRInstruction,
                  values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                  functions: Dict[str, ll.Function]) -> None:
        """生成存储指令"""
    ...
    def _gen_br(self, builder: ll.IRBuilder, instr: IRInstruction,
               values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
               functions: Dict[str, ll.Function]) -> None:
        """生成无条件跳转指令"""
    ...
    def _gen_cbranch(self, builder: ll.IRBuilder, instr: IRInstruction,
                    values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                    functions: Dict[str, ll.Function]) -> None:
        """生成条件跳转指令"""
    ...
    def _gen_ret(self, builder: ll.IRBuilder, instr: IRInstruction,
                values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                functions: Dict[str, ll.Function]) -> None:
        """生成返回指令"""
        if instr.operands:
    ...
    def _gen_call(self, builder: ll.IRBuilder, instr: IRInstruction,
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> ll.Value:
        """生成函数调用指令"""
    ...
    def _gen_zext(self, builder: ll.IRBuilder, instr: IRInstruction,
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> ll.Value:
        """生成零扩展指令"""
        val = self._get_value(instr.operands[0], values)
    ...
    def _gen_sext(self, builder: ll.IRBuilder, instr: IRInstruction,
                 values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                 functions: Dict[str, ll.Function]) -> ll.Value:
        """生成符号扩展指令"""
        val = self._get_value(instr.operands[0], values)
    ...
    def _gen_trunc(self, builder: ll.IRBuilder, instr: IRInstruction,
                  values: Dict[str, ll.Value], blocks: Dict[str, ll.Block],
                  functions: Dict[str, ll.Function]) -> ll.Value:
        """生成截断指令"""
        val = self._get_value(instr.operands[0], values)
...
def generate_llvm_instruction(builder: ll.IRBuilder, instr: IRInstruction,
