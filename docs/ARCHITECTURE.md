...
```bash
# 编译单文件
python -m zhpp hello.zhc

# 编译项目
python -m zhpp build project/

# 清理缓存
python -m zhpp clean --cache

# 性能分析
python -m zhpp profile input.zhc

# 生成文档
python -m zhpp doc api/
```
...
from zhpp.parser.base import BaseParser
...
参见 `src/zhpp/keywords.py`，共258个关键词。

### B. API参考文档

- 在线文档: https://zhc.readthedocs.io
- 本地生成: `python -m zhpp doc api/`
